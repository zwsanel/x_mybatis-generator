...
public class VirtualPrimaryKeyPlugin extends PluginAdapter {
    ...
    /* (non-Javadoc)
     * @see com.sanel.mybatis.generator.api.Plugin#validate(java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.sanel.mybatis.generator.api.PluginAdapter#initialized(com.sanel.mybatis.generator.api.IntrospectedTable)
     */
    @Override
