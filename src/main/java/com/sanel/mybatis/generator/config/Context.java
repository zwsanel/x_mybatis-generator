...
import com.sanel.mybatis.generator.internal.JDBCConnectionFactory;
import com.sanel.mybatis.generator.internal.ObjectFactory;
import com.sanel.mybatis.generator.internal.PluginAggregator;
import com.sanel.mybatis.generator.internal.db.DatabaseIntrospector;
    ...
    public void introspectTables(ProgressCallback callback,
        ...
        try {
            ...
            for (TableConfiguration tc : tableConfigurations) {
                ...
                // 原生的generator无法获取表注释，这里进行获取数据埋点
                String createTableSql = SQLValidate.getCreateTableSql(connection, tableName);
                Table table = SQLValidate.parserToTable(createTableSql);
                tc.setTableComment(table.getComment());
                ...
                callback.ddlRulesValidate(connection, tc.getTableName());
